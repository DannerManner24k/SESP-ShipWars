        ...
        for (int i = 0; i < collidableEntities.size(); i++) {
            ...
            for (int j = i + 1; j < collidableEntities.size(); j++) {
                ...
                if (collides((Entity) collidable1, (Entity) collidable2)) {
                    System.out.println("Collision detected between: " + collidable1 + " and " + collidable2);
                    collidable1.onCollision(gameData, world, collidable2);
                    collidable2.onCollision(gameData, world, collidable1);

                    // Handle specific collision cases, e.g., bullet and terrain
